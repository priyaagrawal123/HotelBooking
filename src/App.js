...
import { OngoingActivitiesProvider } from './OngoingActivitiesContext'; // Adjust the path as needed
// Sample hotels data
const hotels = [
    ...
    < OngoingActivitiesProvider >
      <Router>
        ...
        <Routes>
          ...
          <Route path="/affordable" element={<HotelsList hotels={affordableHotels} />} />
          <Route path="/3star" element={<HotelsList hotels={threeStarHotels} />} />
          <Route path="/5star" element={<HotelsList hotels={fiveStarHotels} />} />
          <Route path="/luxury" element={<HotelsList hotels={luxuryHotels} />} />
